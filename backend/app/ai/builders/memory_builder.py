...
class MemoryBuilder:
    ...
    def __init__(self, gateway: AIGateway) -> None:
        ...
        self._system_prompt = (
            ...
            "Extract ANY new, useful long-term facts, preferences, ongoing tasks, "
            "or relationships that should be remembered forever.\n\n"
            "IMPORTANT RULES:\n"
            ...
            "- Use clear, specific keys (e.g., 'favorite_food', 'spouse_name', 'hometown')\n\n"
